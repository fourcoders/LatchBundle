...
namespace Fourcoders\Bundle\LatchBundle\Latch;
...
final class Latch {
	...
	private function HTTP_GET_proxy($url) {
		return new \Fourcoders\Bundle\LatchBundle\Latch\LatchResponse($this->HTTP_GET(self::$API_HOST . $url, $this->authenticationHeaders("GET", $url, null)));
	}
